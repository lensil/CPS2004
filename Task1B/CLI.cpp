...
void CLI::addCustomer(Customer* customer) {
    vector<Customer*> temp = this->customers;
...
void CLI::addShipment(Shipment* shipment, Customer* customer) {
    vector<Customer*> temp = this->customers;
    vector<Shipment*> temp2 = customer->getShipments();
    temp2.push_back(shipment);
    customer->setShipments(temp2);
    temp.push_back(customer);
    this->customers = temp;
    temp.clear();
    temp2.clear();
