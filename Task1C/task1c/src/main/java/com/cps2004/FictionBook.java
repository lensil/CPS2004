...
public class FictionBook extends Book{
    ...
    public void save(ObjectNode newItem) {
        newItem.put("type", "fictionbook");
        super.save(newItem);
        newItem.put("genre", this.genre);
        newItem.put("publicationDate", this.publicationDate);
    }
    ...
    public void load(JsonNode node) {
        ...
        publicationDate = node.get("publicationDate").asText();
    }
}
